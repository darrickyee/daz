DRIVER_LIST = [
    {
        ...
        # Name of reference location joint (without _L, _R, _M suffix)
        'RefJntName': 'Jaw',
        # Name of driver location joint (without _L, _R, _M suffix)
        'DrvJntName': 'JawEnd',
        'PoseRot': (0, 0, -25),      # Pose rotation relative to reference
        # Weight driver radius (in degrees, for left-side joint)
        'PoseRadius': 25,
        'Keys': {                    # Blendshape targets and (position, value) keys
            'JCM_JawOpen_25': [(0.0, 0.0), (0.5, 1.0), (1.0, 1.0)]
        },
        # Create _L and _R drivers? (False: _M driver)
        'Mirror':False,
